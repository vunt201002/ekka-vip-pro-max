                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <h4 class="m-b-0">Tạo voucher</h4>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="align-justify-center">
                                    <a href="#" class="btn btn-default btn-sm flex-right modal-control" data-toggle="modal" atr="Create">Voucher<i class="fas fa-plus m-l-5"></i></a> 
                                </div>
                            </div>
                        </div>
                        <div class="m-t-25">
...
@section('js')
    ...
    <script src="{{ asset('manager/assets/js/page/voucher.js') }}"></script>
