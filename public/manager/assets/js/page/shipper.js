    ...
    modals: {
        ...
        Create: {
            ...
            getVal(){
                ...
                if (data_address == "") { required_data.push('Hãy nhập tên địa chỉ.'); onPushData = false }
                if (data_phone == "") { required_data.push('Hãy nhập điện thoại.'); onPushData = false }
            ...
            init() {
                ...
                var modalBodyHTML   = Template.Shipper.Create();
        ...
        Update: {
            ...
            setVal(data){
                ...
                $(this.resource).find('.data-phone').val(data[0].telephone);
            },
            getVal(){
                var resource = this.resource;
                var fd = new FormData();
            ...
            init() {
                ...
                var modalBodyHTML  = Template.Shipper.Update();
        ...
        Delete: {
            ...
            init() {
                ...
                var modalBodyHTML  = Template.Shipper.Delete();
