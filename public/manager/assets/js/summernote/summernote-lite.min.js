/*! For license information please see summernote-lite.min.js.LICENSE.txt */ ! function(t, e) {
    ...
    return function(t) {
        ...
        3: function(t, e, n) {
            ...
            function dt(t, e) { if (t && t.parentNode) { if (t.removeNode) return t.removeNode(e); var n = t.parentNode; if (!e) { for (var o = [], i = 0, r = t.childNodes.length; i < r; i++) o.push(t.childNodes[i]); for (var a = 0, s = o.length; a < s; a++) n.insertBefore(o[a], t) } n.removeChild(t) } }
            var ht = T("TEXTAREA");
            ...
            var Ft = function() {
                ...
                return e = t, (n = [{
                    ...
                    value: function(t, e) {
                        ...
                        if ("top" === e) o.before(a);
                        else { if (n.rowSpan > 1) { var f = o[0].rowIndex + (n.rowSpan - 2); return void i()(i()(o).parent().find("tr")[f]).after(i()(a)) } o.after(a) }
                    }
                }, {
                    key: "addCol",
                    value: function(t, e) {
